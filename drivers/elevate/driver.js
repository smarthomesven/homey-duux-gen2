...
module.exports = class ElevateDriver extends Homey.Driver {
   ...
   */
  async onInit() {
    this.log('Elevate driver has been initialized');
    const enableHorizontalOscillationAction = this.homey.flow.getActionCard('enable_horizontal_oscillation_elevate');
    const disableHorizontalOscillationAction = this.homey.flow.getActionCard('disable_horizontal_oscillation_elevate');
    const enableNightModeAction = this.homey.flow.getActionCard('enable_night_mode_elevate');
    const disableNightModeAction = this.homey.flow.getActionCard('disable_night_mode_elevate');
    const enableIonizerAction = this.homey.flow.getActionCard('enable_ionizer_elevate');
    const disableIonizerAction = this.homey.flow.getActionCard('disable_ionizer_elevate');
    const setModeAction = this.homey.flow.getActionCard('set_elevate_mode');
    const horizontalOscillationCondition = this.homey.flow.getConditionCard('horizontal_oscillation_condition_elevate');
    const nightModeCondition = this.homey.flow.getConditionCard('night_mode_condition_elevate');
    const ionizerCondition = this.homey.flow.getConditionCard('ionizer_condition_elevate');
    const modeCondition = this.homey.flow.getConditionCard('mode_condition_elevate');

    horizontalOscillationCondition.registerRunListener(async (args, state) => {
      const device = args.device;
      const isSwing = device.getCapabilityValue('horizontal_oscillation');
      return isSwing;
    });
    ...
    nightModeCondition.registerRunListener(async (args, state) => {
      const device = args.device;
      const isNightModeOn = device.getCapabilityValue('night_mode');
