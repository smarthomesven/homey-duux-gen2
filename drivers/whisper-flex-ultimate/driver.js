...
module.exports = class WhisperFlexUltimateDriver extends Homey.Driver {

  /**
   * onInit is called when the driver is initialized.
   */
  async onInit() {
    this.log('Whisper Flex Ultimate driver has been initialized');
  }
  ...
  async onPair(session) {
    this.log('Whisper Flex Ultimate pairing started');
    this._type = "pair";
  ...
  async onRepair(session) {
    this.log('Whisper Flex Ultimate repairing started');
    this._type = "repair";
    this._session = session;
