...
module.exports = class WhisperFlex2Driver extends Homey.Driver {

  /**
   * onInit is called when the driver is initialized.
   */
  async onInit() {
    this.log('Whisper Flex 2 driver has been initialized');
  }
  ...
  async onPair(session) {
    this.log('Whisper Flex 2 pairing started');
    this._type = "pair";
  ...
  async onRepair(session) {
    this.log('Whisper Flex 2 repairing started');
    this._type = "repair";
    this._session = session;
