...
module.exports = class EdgeOilDriver extends Homey.Driver {

  /**
   * onInit is called when the driver is initialized.
   */
  async onInit() {
    this.log('Edge Oil driver has been initialized');
  }
  ...
  async onPair(session) {
    this.log('Edge Oil pairing started');
    this._type = "pair";
  ...
  async onRepair(session) {
    this.log('Edge Oil repairing started');
    this._type = "repair";
    this._session = session;
